            ...
            {generations.map((generation) => (
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  <div className="relative aspect-square"> {/* Changed from pt-[100%] */}
                    <div className="absolute inset-0 border-2 border-gray-800 rounded-lg overflow-hidden">
                      <Image
                        src={generation.modelImageUrl}
                        alt="Model"
                        fill
                        className="object-contain p-1" // Changed from object-cover
                ...
                {/* Result Image */}
                <div className="relative aspect-[3/4] mb-4"> {/* Changed aspect ratio */}
                  <div className="absolute inset-0 border-2 border-gray-800 rounded-lg overflow-hidden">
                    <Image
